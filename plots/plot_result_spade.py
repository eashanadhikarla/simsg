...
ea = event_accumulator.EventAccumulator('events.out.tfevents.1620079233.magic01')
ea.Reload()
ea.Tags()
...
# plt.ylabel('LOSS')
# plt.grid(True)
# plt.savefig('spade_gen_loss.png')
